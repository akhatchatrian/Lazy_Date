          ...
          <div className="date-carousel">
                ...
                <div className="date-main-container">
                    <div className="date-main-header">
                        ...
                        {currentDate.rating ?
                            (<div className='star-rating'> {this.getStars(currentDate.rating)} ({currentDate.review_count})</div>)
                        : null }
                    </div>
                    ...
                    <div className="date-detailed-info">
                        ...
                        {currentDate.rating ?
                            (<div className='detail-rating'> {this.getStars(currentDate.rating)}</div>)
                            : null }
